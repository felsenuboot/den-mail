"""Dark-mode transformation for HTML mail: flip the lightness of every colour
the message specifies while keeping hue and saturation (and images) intact.
This is the same idea Fastmail's web client uses."""
...
COLOR_PROPS = {
    ...
    "border-left-color", "outline", "outline-color", "text-shadow", "box-shadow", "text-decoration-color",
    "caret-color", "column-rule-color", "fill", "stroke", "background-image",
}
COLOR_ATTRS = {"bgcolor", "color", "text", "link", "alink", "vlink", "bordercolor"}
...
def flip_css(css: str) -> str:
    """Flip colours inside colour-related declarations of a style attribute or sheet."""
...
def declares_dark_support(html: str) -> bool:
    low = html.lower()
    return ('name="color-scheme"' in low and "dark" in low) or "prefers-color-scheme" in low
